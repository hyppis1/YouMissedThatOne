...
6.2.2026 - Fixed fast weapons and rewrote the SoundManager to use RuneLite’s AudioPlayer instead of javax.sound.sampled. 
Note: overlapping sounds are now always allowed, as per the new audio system.